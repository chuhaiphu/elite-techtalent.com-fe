...
import { MAX_IMAGE_COUNT_ALLOWED, PAGE_TYPES, VN_PROVINCES } from '@/constants';
...
export default function AdminPageDetailPageContentContainer({
  ...
  const handleCopyLink = () => {
    const link = `https://elite-techtalent.com/${endpoint}`;
                ...
                <Group gap={'xs'} justify="space-between" wrap="nowrap">
                  <Group gap={0} wrap="nowrap" className={classes.urlGroup}>
                    <Group gap={4}>
                      ...
                      <Text size="md">elite-techtalent.com/</Text>
                    </Group>
                    <Group gap={0}>
                      <TextInput
            ...
            <Stack gap={'0'}>
              ...
              <Group justify="space-between" wrap="nowrap" mt={'sm'}>
                ...
                <Group gap={'xs'}>
                  ...
                  <Button
                    onClick={() => {
                      router.push('/admin/page' as Route);
                    }}
                    variant="filled"
                    color="blue"
                    size="xs"
      ...
      >
        <Stack gap={4}>
          ...
          <Stack gap={4}>
            <Text
              component="a"
              href={`https://elite-techtalent.com/${endpoint}`}
              target="_blank"
              size="lg"
              fw={500}
              c={'var(--vinaup-teal)'}
            ...
            >
              https://elite-techtalent.com/{endpoint}
            </Text>
            <Text size="sm">
