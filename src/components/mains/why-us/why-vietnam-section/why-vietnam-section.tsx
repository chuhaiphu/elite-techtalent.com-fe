...
const ROWS: { label: string; content: ReactNode }[] = [
  {
    ...
    content: (
      <>
        ...
        <span className={classes.highlight}>more than 50,000</span> new tech
        graduates each year, making it a prime location for skilled IT
        professionals.
      </>
    ),
  },
  ...
  },
  {
    ...
    content: (
      <>
        Vietnam&apos;s Government has implemented incentives and investments to
        support the tech industry, creating a favourable environment for{' '}
...
const QUOTES = [
  ...
  {
    quote:
      'Vietnam ICT is the fastest growing market in the region. Organisations solving workforce capability first, will own competitive advantage by 2030.',
