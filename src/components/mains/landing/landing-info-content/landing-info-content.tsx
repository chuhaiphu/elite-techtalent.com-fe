          ...
          <Grid classNames={{
            ...
            <GridCol span={{ base: 12, md: 4 }}>
              <Stack className={classes.contentColContent}>
                ...
                <p className={classes.contentColDescription}>Agile and responsive support to meet urgent needs with confidence and assurance.
                </p>
              </Stack>
            </GridCol>
            <GridCol span={{ base: 12, md: 4 }}>
              <Stack className={classes.contentColContent}>
                <h3 className={classes.contentColTitle}>Personalized Interactions</h3>
                <p className={classes.contentColDescription}>Our consultative and collaborative approach helps deliver workforce plans fit for
                  the future.
                </p>
              </Stack>
            </GridCol>
            <GridCol span={{ base: 12, md: 4 }}>
              <Stack className={classes.contentColContent}>
                ...
                <p className={classes.contentColDescription}>Access to a network of top-tier IT professionals, carefully selected to guarantee innovation and reliability for your organisation.</p>
              </Stack>
            </GridCol>
          </Grid>
          <Flex mb="xl">
            <div className={classes.hexagonBorder}>
              <div className={classes.hexagonInner}>
                <Image
                  src="/partnership-thumbnail.webp"
                  alt="Partnership"
                  fill={true}
            ...
            <Stack className={classes.textStack} align="center" justify="center">
              ...
              <p className={classes.textContentDescription}>Together, we can drive innovation and growth for
                your business, maximising long term success.</p>
            </Stack>
          </Flex>
        </Stack>
      </Container>
