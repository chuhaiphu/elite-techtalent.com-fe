...
export default function AdminSettingEmailSmtpLayoutContent({
  children,
}: AdminSettingEmailSmtpLayoutContentProps) {
  const router = useRouter();
  const pathname = usePathname();

  const getActiveTab = () => {
    if (pathname === '/admin/setting/email-smtp/email-template')
  ...
  return (
    ...
    >
      <TabsList>
        <TabsTab value="smtp">SMTP Configuration</TabsTab>
