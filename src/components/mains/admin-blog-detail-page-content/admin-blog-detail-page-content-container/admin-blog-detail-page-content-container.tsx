...
export default function AdminBlogDetailPageContentContainer({
  ...
  const handleCopyLink = () => {
    const link = `https://elite-techtalent.com/blogs/${currentBlogData.endpoint}`;
            ...
            <Paper p={'sm'} radius={'md'} classNames={{ root: classes.paperBlock }}>
              <Stack gap={'xs'}>
                ...
                <Group gap={'xs'} justify="space-between">
                  <Text size="md">
                    URL: elite-techtalent.com/blogs/{currentBlogData.endpoint}
                  </Text>
                  <Group>
                    <Text
                      size="sm"
            ...
            >
              <Stack gap={4}>
                ...
                <Stack gap={4}>
                  <Text
                    component="a"
                    href={`https://elite-techtalent.com/blogs/${currentBlogData.endpoint}`}
                    target="_blank"
                    size="lg"
                    fw={500}
                    c={'var(--vinaup-teal)'}
                  ...
                  >
                    https://elite-techtalent.com/blogs/{currentBlogData.endpoint}
                  </Text>
                  <Text size="sm">
