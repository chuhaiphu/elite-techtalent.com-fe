...
const SERVICES: {
  ...
  {
    image: '/images/look-up-paper.webp',
    headerContent: <h3 className={classes.text}>HEAD HUNTING</h3>,
    paragraphContent: (
      <p className={classes.bodyText}>
        Providing the right candidates for your team for permanent roles.
      </p>
    ),
  },
  {
    image: '/images/three-people-working.webp',
    headerContent: <h3 className={classes.text}>STAFF AUGMENTATION</h3>,
    paragraphContent: (
      <p className={classes.bodyText}>
        Scalable IT talent for every project stage – rapid deployment of skilled
        tech professionals, on short or long-term engagements.
      </p>
    ),
  },
  {
    image: '/images/four-people-thumb-up.webp',
      ...
      <Stack gap={8}>
        <p>
          ...
          <span className={classes.bodyText}>
            {' '}
            – we create your highly skilled, long-term commitment, developer team,
            based overseas.
          </span>
        </p>
        <p>
          ...
          <span className={classes.bodyText}>
            {' '}
            – we manage the set-up, ensuring legal compliance and local cultural
            fit.
          </span>
        </p>
        <p>
          ...
          <span className={classes.bodyText}>
            {' '}
            – at a pre-determined time, we transfer full responsibility and
            management of the team to your organisation.
          </span>
        </p>
      </Stack>
    ),
  ...
  {
    image: '/images/compliance-word-sample.webp',
    headerContent: (
      <>
    ...
    paragraphContent: (
      <p>
        ...
        <span className={classes.bodyText}>
          , taking care of all mandatory employment documentation, tax filings, and
          local legal compliance – you simply manage and direct the team&apos;s
          day-to-day work. Simply put, you get to build and oversee an offshore team
          without the need to establish a local entity.
        </span>
      </p>
    ),
  },
  {
    image: '/images/two-people-coding.webp',
    ...
    paragraphContent: (
      <>
        ...
        <ul className={classes.bodyList}>
          <li className={classes.bodyListItem}>
            End-to-end HR management: contracts, payroll, compliance
          </li>
          <li className={classes.bodyListItem}>
            Reduce in-house HR workload and legal risks
          </li>
          <li className={classes.bodyListItem}>
            Customisable solutions for teams of all sizes
          </li>
        </ul>
      </>
    ),
            ...
            <GridCol key={i} span={{ base: 15, lg: 3 }}>
              <Stack className={classes.card}>
                ...
                <Stack className={classes.cardContent}>
                  <Stack gap="xs" align="center" className={classes.headerContent}>
                    {item.headerContent}
                  </Stack>
