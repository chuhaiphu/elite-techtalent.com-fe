...
export async function createMediaAction(
  ...
  const result = await executeApi(async () => createMediaApi(input));
...
export async function createManyMediaAction(
  ...
  try {
    ...
    for (const mediaInput of input) {
      const result = await executeApi(async () => createMediaApi(mediaInput));
...
export async function getMediaByIdAction(
  ...
  return executeApi(async () => getMediaByIdApi(id));
}

export async function getAllMediaAction(): Promise<
  ActionResponse<IMediaResponse[]>
> {
  return executeApi(async () => getAllMediaApi());
}
...
export async function updateMediaAction(
  ...
  const result = await executeApi(async () => updateMediaApi(id, input));
  revalidatePath('/admin/media');
  return result;
}
...
export async function deleteMediaAction(
  ...
  const mediaResult = await executeApi(async () => getMediaByIdApi(id));

  const result = await executeApi(async () => deleteMediaApi(id));
...
export async function upsertMediaAction(
  ...
  const allMedia = await executeApi(async () => getAllMediaApi());
